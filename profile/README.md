...
| [**solder-pico2**](https://github.com/sysl-lang/solder-pico2) | the same trick for the other language — SOLDER on a Pico 2 W in 400 KB of flash, the board console being the desktop one with its first few lines swapped |
